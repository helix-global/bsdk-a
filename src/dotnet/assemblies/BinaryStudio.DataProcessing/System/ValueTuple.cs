...
namespace System
{
        ...
        : IEquatable<ValueTuple>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple>, ITupleInternal
    {
        ...
        int IComparable.CompareTo(object other)
        {
            ...
            {
                throw new ArgumentException(Environment.GetResourceString("ArgumentException_ValueTupleIncorrectType", GetType().ToString()), nameof(other));
            }
        ...
        /// <summary>Creates a new struct 6-tuple, or ----tuple.</summary>
        /// <typeparam name="T1">The type of the first component of the tuple.</typeparam>
        /// <typeparam name="T2">The type of the second component of the tuple.</typeparam>
        /// <typeparam name="T3">The type of the third component of the tuple.</typeparam>
        /// <typeparam name="T4">The type of the fourth component of the tuple.</typeparam>
        ...
        /// <returns>A 6-tuple (----tuple) whose value is (item1, item2, item3, item4, item5, item6).</returns>
