...
namespace BinaryStudio.IO
    ...
    public class XmlWriterAdapter : XmlWriter
        ...
        protected XmlWriterAdapter(XmlWriter writer)
            {
            this.writer = writer;
            }
        ...
        public virtual void WriteStartAttribute(String localname, Boolean newline)
            {
        ...
        public IDisposable CDataScope()
            {
            return new XmlWriterAdapterCDataScope(this);
            }

        protected virtual void WriteStartCData()
            {
            }

        protected virtual void WriteEndCData()
            {
            }

        public virtual void WriteWhitespace(Int32 length)
            {
            }
        ...
        public new IDisposable WriteStartElement(String localname)
            {
            WriteStartElement(null, localname, null);
            return new XmlWriterAdapterElementScope(this);
            }

        #region T:XmlWriterAdapterElementScope
        private class XmlWriterAdapterElementScope : IDisposable
            {
            private readonly XmlWriter writer;
            public XmlWriterAdapterElementScope(XmlWriter writer) {
                this.writer = writer;
                }
            public void Dispose()
                {
        ...
        private class XmlWriterAdapterCDataScope : IDisposable
            {
            private readonly XmlWriterAdapter writer;
            public XmlWriterAdapterCDataScope(XmlWriterAdapter writer)
                {
                this.writer = writer;
