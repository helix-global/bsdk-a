...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificatePermittedNameConstraintException : CertificateConstraintException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificatePermittedNameConstraintException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificatePermittedNameConstraintException(String message, IEnumerable<Exception> innerExceptions)
