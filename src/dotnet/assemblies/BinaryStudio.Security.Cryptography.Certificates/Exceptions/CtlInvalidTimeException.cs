...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CtlInvalidTimeException : CtlException
        ...
        /// <summary>Initializes a new instance of the <see cref="CtlInvalidTimeException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CtlInvalidTimeException(String message, IEnumerable<Exception> innerExceptions)
