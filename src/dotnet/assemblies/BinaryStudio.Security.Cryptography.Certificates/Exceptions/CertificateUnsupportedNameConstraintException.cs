...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateUnsupportedNameConstraintException : CertificateConstraintException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateUnsupportedNameConstraintException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateUnsupportedNameConstraintException(String message, IEnumerable<Exception> innerExceptions)
