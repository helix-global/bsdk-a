...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateIsCyclicException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateIsCyclicException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateIsCyclicException(String message, IEnumerable<Exception> innerExceptions)
