...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateStoreNotFoundException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateStoreNotFoundException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateStoreNotFoundException(String message, IEnumerable<Exception> innerExceptions)
