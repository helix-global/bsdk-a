...
namespace BinaryStudio.Security.Cryptography
    {
    public class CtlException : SecurityException
        {
        ...
        /// <summary>Initializes a new instance of the <see cref="CtlException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        protected CtlException(String message, IEnumerable<Exception> innerExceptions)
