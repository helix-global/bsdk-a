...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateExpiredException : CertificateInvalidTimeException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateExpiredException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateExpiredException(String message, IEnumerable<Exception> innerExceptions)
