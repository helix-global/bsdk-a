...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateInvalidPolicyConstraintException : CertificateConstraintException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateInvalidPolicyConstraintException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateInvalidPolicyConstraintException(String message, IEnumerable<Exception> innerExceptions)
