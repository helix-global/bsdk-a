...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateUndefinedNameConstraintException : CertificateConstraintException
        {
        /// <summary>Initializes a new instance of the <see cref="CertificateUndefinedNameConstraintException"/> class with a specified message that describes the error.</summary>
        /// <param name="message">The message that describes the exception. The caller of this constructor is required to ensure that this string has been localized for the current system culture.</param>
        public CertificateUndefinedNameConstraintException(String message)
            : base(message)
            {
            }
        ...
        public CertificateUndefinedNameConstraintException()
            :this(Resources.ResourceManager.GetString(nameof(CertificateChainErrorStatus.CERT_TRUST_HAS_NOT_DEFINED_NAME_CONSTRAINT)))
            {
            }

        /// <summary>Initializes a new instance of the <see cref="CertificateUndefinedNameConstraintException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateUndefinedNameConstraintException(String message, IEnumerable<Exception> innerExceptions)
