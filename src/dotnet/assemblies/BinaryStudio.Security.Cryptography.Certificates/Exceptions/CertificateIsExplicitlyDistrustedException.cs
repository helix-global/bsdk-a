...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateIsExplicitlyDistrustedException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateIsExplicitlyDistrustedException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateIsExplicitlyDistrustedException(String message, IEnumerable<Exception> innerExceptions)
