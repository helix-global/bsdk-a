...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CrlMissingException : CrlException
        ...
        public CrlMissingException(String message)
            : base(message)
            {
            }

        /// <summary>Initializes a new instance of the <see cref="CrlMissingException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CrlMissingException(String message, IEnumerable<Exception> innerExceptions)
