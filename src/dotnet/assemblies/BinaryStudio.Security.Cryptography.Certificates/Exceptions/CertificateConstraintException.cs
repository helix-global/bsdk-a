...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateConstraintException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateConstraintException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateConstraintException(String message, IEnumerable<Exception> innerExceptions)
