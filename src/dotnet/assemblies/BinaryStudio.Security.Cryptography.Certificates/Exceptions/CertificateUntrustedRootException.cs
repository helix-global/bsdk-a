...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateUntrustedRootException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateUntrustedRootException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateUntrustedRootException(String message, IEnumerable<Exception> innerExceptions)
