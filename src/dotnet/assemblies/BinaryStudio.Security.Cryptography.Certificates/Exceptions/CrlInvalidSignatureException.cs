...
namespace BinaryStudio.Security.Cryptography
    {
    public class CrlInvalidSignatureException : CrlSignatureException
        {
        ...
        /// <summary>Initializes a new instance of the <see cref="CrlInvalidSignatureException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CrlInvalidSignatureException(String message, IEnumerable<Exception> innerExceptions)
