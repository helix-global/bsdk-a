...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateInvalidNameConstraintException : CertificateConstraintException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateInvalidNameConstraintException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateInvalidNameConstraintException(String message, IEnumerable<Exception> innerExceptions)
