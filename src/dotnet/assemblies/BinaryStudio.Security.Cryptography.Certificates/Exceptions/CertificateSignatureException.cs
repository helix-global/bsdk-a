...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateSignatureException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateSignatureException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateSignatureException(String message, IEnumerable<Exception> innerExceptions)
