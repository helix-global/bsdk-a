...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateInvalidSignatureException : CertificateSignatureException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateInvalidSignatureException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateInvalidSignatureException(String message, IEnumerable<Exception> innerExceptions)
