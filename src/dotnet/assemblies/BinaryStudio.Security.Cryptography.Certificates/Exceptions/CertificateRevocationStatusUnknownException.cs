...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateRevocationStatusUnknownException : CertificateRevocationException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateRevocationStatusUnknownException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateRevocationStatusUnknownException(String message, IEnumerable<Exception> innerExceptions)
