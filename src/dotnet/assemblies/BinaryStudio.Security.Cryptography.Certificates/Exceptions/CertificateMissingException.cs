...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateMissingException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateMissingException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateMissingException(String message, IEnumerable<Exception> innerExceptions)
