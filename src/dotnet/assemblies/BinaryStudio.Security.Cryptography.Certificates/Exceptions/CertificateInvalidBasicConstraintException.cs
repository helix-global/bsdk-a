...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateInvalidBasicConstraintException : CertificateConstraintException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateInvalidBasicConstraintException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateInvalidBasicConstraintException(String message, IEnumerable<Exception> innerExceptions)
