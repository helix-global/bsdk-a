...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CtlInvalidUsageException : CtlException
        ...
        /// <summary>Initializes a new instance of the <see cref="CtlInvalidUsageException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CtlInvalidUsageException(String message, IEnumerable<Exception> innerExceptions)
