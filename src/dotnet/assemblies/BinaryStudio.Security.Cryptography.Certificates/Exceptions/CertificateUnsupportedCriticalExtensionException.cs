...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateUnsupportedCriticalExtensionException : CertificateInvalidExtensionException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateUnsupportedCriticalExtensionException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateUnsupportedCriticalExtensionException(String message, IEnumerable<Exception> innerExceptions)
