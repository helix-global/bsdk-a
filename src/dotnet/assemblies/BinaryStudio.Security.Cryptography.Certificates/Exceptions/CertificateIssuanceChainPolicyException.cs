...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateIssuanceChainPolicyException : CertificateException
        {
        /// <summary>Initializes a new instance of the <see cref="CertificateIssuanceChainPolicyException"/> class with a specified message that describes the error.</summary>
        /// <param name="message">The message that describes the exception. The caller of this constructor is required to ensure that this string has been localized for the current system culture.</param>
        public CertificateIssuanceChainPolicyException(String message)
            :base(message)
            {
            }
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateIssuanceChainPolicyException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateIssuanceChainPolicyException(String message, IEnumerable<Exception> innerExceptions)
