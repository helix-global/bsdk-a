...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CtlInvalidSignatureException : CtlException
        ...
        /// <summary>Initializes a new instance of the <see cref="CtlInvalidSignatureException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CtlInvalidSignatureException(String message, IEnumerable<Exception> innerExceptions)
