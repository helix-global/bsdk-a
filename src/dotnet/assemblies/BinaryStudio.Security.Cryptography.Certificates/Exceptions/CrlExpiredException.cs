...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CrlExpiredException : CrlInvalidTimeException
        ...
        /// <summary>Initializes a new instance of the <see cref="CrlExpiredException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CrlExpiredException(String message, IEnumerable<Exception> innerExceptions)
