...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateRevocationException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateRevocationException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateRevocationException(String message, IEnumerable<Exception> innerExceptions)
