...
namespace BinaryStudio.Security.Cryptography
    {
    public class CrlException : SecurityException
        {
        ...
        /// <summary>Initializes a new instance of the <see cref="CrlException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
