...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateInvalidExtensionException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificateInvalidExtensionException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateInvalidExtensionException(String message, IEnumerable<Exception> innerExceptions)
