...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificateRootAuthorityExpiredException : CertificateExpiredException
        ...
        public CertificateRootAuthorityExpiredException(String message)
            : base(message)
            {
            }

        /// <summary>Initializes a new instance of the <see cref="CertificateRootAuthorityExpiredException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificateRootAuthorityExpiredException(String message, IEnumerable<Exception> innerExceptions)
