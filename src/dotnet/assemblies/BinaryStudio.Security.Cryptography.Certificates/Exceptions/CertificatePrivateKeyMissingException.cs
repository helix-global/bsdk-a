...
namespace BinaryStudio.Security.Cryptography
    ...
    public class CertificatePrivateKeyMissingException : CertificateException
        ...
        /// <summary>Initializes a new instance of the <see cref="CertificatePrivateKeyMissingException"/> class with a specified error message and references to the inner exceptions that are the cause of this exception.</summary>
        ...
        public CertificatePrivateKeyMissingException(String message, IEnumerable<Exception> innerExceptions)
