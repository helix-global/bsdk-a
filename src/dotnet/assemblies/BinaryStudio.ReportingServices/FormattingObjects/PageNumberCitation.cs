...
namespace BinaryStudio.ReportingServices.FormattingObjects
    ...
    [XmlRoot(Namespace = "http://www.w3.org/1999/XSL/Format",ElementName="page-number-citation")]
    public class PageNumberCitation : GenericInline
        {
        ...
        public static XmlSerializer Serializer { get {
            serializer = serializer ?? new XmlSerializer(typeof(PageNumberCitation));
            return serializer;
            }}
        #endregion
