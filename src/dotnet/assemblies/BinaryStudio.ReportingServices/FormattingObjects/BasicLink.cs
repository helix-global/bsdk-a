...
namespace BinaryStudio.ReportingServices.FormattingObjects
    ...
    [XmlRoot(Namespace = "http://www.w3.org/1999/XSL/Format",ElementName="basic-link")]
    public class BasicLink : GenericInline
        {
        public BasicLink()
            {
            }
        ...
        public static XmlSerializer Serializer { get {
            serializer = serializer ?? new XmlSerializer(typeof(BasicLink));
            return serializer;
            }}
        #endregion
