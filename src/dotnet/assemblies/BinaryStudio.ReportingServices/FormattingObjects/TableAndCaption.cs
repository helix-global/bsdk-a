...
namespace BinaryStudio.ReportingServices.FormattingObjects
    ...
    [XmlRoot(Namespace = "http://www.w3.org/1999/XSL/Format",ElementName="table-and-caption")]
    public class TableAndCaption : GenericBlock,ICommonAccessibilityProperties,ICommonAuralProperties,ICommonBorderPaddingAndBackgroundProperties,ICommonMarginPropertiesBlock,ICommonRelativePositionProperties
        {
        ...
        [XmlAttribute("caption-side")] public String CaptionSide { get;set; }
        ...
        [XmlElement("table")] public Table Table { get;set; }
        [XmlElement("table-caption")] public TableCaption TableCaption { get;set; }
        ...
        public static XmlSerializer Serializer { get {
            serializer = serializer ?? new XmlSerializer(typeof(TableAndCaption));
            return serializer;
            }}
        #endregion
