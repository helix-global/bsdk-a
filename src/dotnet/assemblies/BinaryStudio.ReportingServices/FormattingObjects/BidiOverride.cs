...
namespace BinaryStudio.ReportingServices.FormattingObjects
    ...
    [XmlRoot(Namespace = "http://www.w3.org/1999/XSL/Format",ElementName="bidi-override")]
    public class BidiOverride : GenericInline
        {
        public BidiOverride()
            {
            }
        ...
        public static XmlSerializer Serializer { get {
            serializer = serializer ?? new XmlSerializer(typeof(BidiOverride));
            return serializer;
            }}
        #endregion
