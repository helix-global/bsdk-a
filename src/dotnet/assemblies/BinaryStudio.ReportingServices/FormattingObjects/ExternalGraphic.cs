...
namespace BinaryStudio.ReportingServices.FormattingObjects
    ...
    [XmlRoot(Namespace = "http://www.w3.org/1999/XSL/Format",ElementName="external-graphic")]
    public class ExternalGraphic : GenericInline
        {
        ...
        public static XmlSerializer Serializer { get {
            serializer = serializer ?? new XmlSerializer(typeof(ExternalGraphic));
            return serializer;
            }}
        #endregion
