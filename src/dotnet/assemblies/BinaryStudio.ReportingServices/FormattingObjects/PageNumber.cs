...
namespace BinaryStudio.ReportingServices.FormattingObjects
    ...
    [XmlRoot(Namespace = "http://www.w3.org/1999/XSL/Format",ElementName="page-number")]
    public class PageNumber : GenericInline
        {
        public PageNumber()
            {
            }
        ...
        public static XmlSerializer Serializer { get {
            serializer = serializer ?? new XmlSerializer(typeof(PageNumber));
            return serializer;
            }}
        #endregion
