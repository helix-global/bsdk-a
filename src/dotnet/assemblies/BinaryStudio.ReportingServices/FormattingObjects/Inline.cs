...
namespace BinaryStudio.ReportingServices.FormattingObjects
    ...
    [XmlRoot(Namespace = "http://www.w3.org/1999/XSL/Format",ElementName="inline")]
    public class Inline : GenericInline
        {
        public Inline()
            {
            }
        ...
        public static XmlSerializer Serializer { get {
            serializer = serializer ?? new XmlSerializer(typeof(Inline));
            return serializer;
            }}
        #endregion
