...
namespace BinaryStudio.ReportingServices.FormattingObjects
    ...
    [XmlRoot(Namespace = "http://www.w3.org/1999/XSL/Format",ElementName="conditional-page-master-reference")]
    public class ConditionalPageMasterReference
        ...
        public static XmlSerializer Serializer { get {
            serializer = serializer ?? new XmlSerializer(typeof(ConditionalPageMasterReference));
            return serializer;
            }}
        #endregion
