...
namespace BinaryStudio.ReportingServices.FormattingObjects
    ...
    [XmlRoot(Namespace = "http://www.w3.org/1999/XSL/Format",ElementName="multi-toggle")]
    public class MultiToggle : GenericInline
        {
        public MultiToggle()
            {
            }
        ...
        public static XmlSerializer Serializer { get {
            serializer = serializer ?? new XmlSerializer(typeof(MultiToggle));
            return serializer;
            }}
        #endregion
