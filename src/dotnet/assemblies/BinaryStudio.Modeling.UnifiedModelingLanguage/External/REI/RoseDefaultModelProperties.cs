...
// Type: RationalRose.RoseDefaultModelProperties
...
namespace RationalRose
{
  ...
  [CoClass(typeof (RoseDefaultModelPropertiesClass))]
  [ComImport]
  public interface RoseDefaultModelProperties : IREICOMDefaultModelProperties
  {
  }
}
