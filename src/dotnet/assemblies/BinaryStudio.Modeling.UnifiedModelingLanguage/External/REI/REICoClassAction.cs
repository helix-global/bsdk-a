...
namespace RationalRose
    ...
    [ComImport]
    public class REICoClassAction : IRoseAction, REICOMAction
        {
        ...
        [DispId(12620)]
        public virtual extern String Arguments { [DispId(12620), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12620), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

        [DispId(12621)]
        public virtual extern String Target { [DispId(12621), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12621), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
