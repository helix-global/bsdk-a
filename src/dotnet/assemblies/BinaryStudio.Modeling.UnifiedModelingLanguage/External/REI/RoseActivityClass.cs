...
// Type: RationalRose.RoseActivityClass
...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseActivityClass : IRoseActivity, REICOMActivity
  {
    ...
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.Interface)]
    public virtual extern RoseObjectFlow AddObjectFlow([MarshalAs(UnmanagedType.Interface)] RoseObjectInstance theObjectInstance);

    [DispId(12840)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern Boolean DeleteObjectFlow([MarshalAs(UnmanagedType.Interface)] RoseObjectFlow theObjectFlow);

    [DispId(12853)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.Interface)]
    public virtual extern RoseObjectFlowCollection GetObjectFlows();
