...
namespace RationalRose
    ...
    [ComImport]
    internal class REICoClassAttribute : REICOMAttribute
        {
        ...
        [DispId(434)]
        public virtual extern IREICOMClass ParentClass { [DispId(434), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(434), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
        ...
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern IREICOMClass GetTypeClass();
