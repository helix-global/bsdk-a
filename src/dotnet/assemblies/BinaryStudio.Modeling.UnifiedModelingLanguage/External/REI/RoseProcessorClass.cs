...
namespace RationalRose
{
  ...
  public class RoseProcessorClass : IREICOMProcessor, RoseProcessor
  {
    ...
    [DispId(12819)]
    public virtual extern RoseConnectionRelationCollection Connections { [DispId(12819), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12819), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
    ...
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.Interface)]
    public virtual extern RoseDeviceCollection GetConnectedDevices();
    ...
    [DispId(421)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern Boolean AddDeviceConnection([MarshalAs(UnmanagedType.Interface)] RoseDevice theDevice);

    [DispId(422)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern Boolean RemoveDeviceConnection([MarshalAs(UnmanagedType.Interface)] RoseDevice theDevice);
