...
// Type: RationalRose.RoseConnectionRelationClass
...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseConnectionRelationClass : IREICOMConnectionRelation, REICOMConnectionRelation
  {
    ...
    [DispId(12815)]
    public virtual extern String Characteristics { [DispId(12815), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12815), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

    [DispId(12816)]
    public virtual extern Boolean SupplierIsDevice { [DispId(12816), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12816), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
