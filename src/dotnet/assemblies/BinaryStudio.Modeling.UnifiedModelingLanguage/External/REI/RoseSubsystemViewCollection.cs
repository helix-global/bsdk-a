...
// Type: RationalRose.RoseSubsystemViewCollection
...
namespace RationalRose
{
  ...
  [CoClass(typeof (RoseSubsystemViewCollectionClass))]
  [ComImport]
  public interface RoseSubsystemViewCollection : IREICOMSubsystemViewCollection
  {
  }
}
