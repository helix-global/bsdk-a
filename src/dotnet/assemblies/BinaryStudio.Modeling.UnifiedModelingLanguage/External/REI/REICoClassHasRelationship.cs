...
namespace RationalRose
    ...
    public class REICoClassHasRelationship : IREICOMHasRelationship, REICOMHasRelationship
        ...
        [DispId(820)]
        public virtual extern REICOMRichType ExportControl { [DispId(820), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(820), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

        [DispId(821)]
        public virtual extern REICOMRichType Containment { [DispId(821), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(821), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
