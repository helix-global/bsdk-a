...
// Type: RationalRose.RoseParameterClass
...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseParameterClass : IREICOMParameter, REICOMParameter
  {
    ...
    [DispId(412)]
    public virtual extern Boolean Const { [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
    ...
    [DispId(414)]
    public virtual extern String InitValue { [DispId(414), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(414), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
