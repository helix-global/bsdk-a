...
// Type: RationalRose.RoseStateViewCollection
...
namespace RationalRose
{
  ...
  [CoClass(typeof (RoseStateViewCollectionClass))]
  [ComImport]
  public interface RoseStateViewCollection : IREICOMStateViewCollection
  {
  }
}
