...
// Type: RationalRose.RoseModuleDiagramCollection
...
namespace RationalRose
{
  ...
  [CoClass(typeof (RoseModuleDiagramCollectionClass))]
  [ComImport]
  public interface RoseModuleDiagramCollection : IREICOMModuleDiagramCollection
  {
  }
}
