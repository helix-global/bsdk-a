...
namespace RationalRose
    ...
    [ComImport]
    internal class REICoClassProcess : REICOMProcess
        {
        ...
        [DispId(412)]
        public virtual extern IREICOMProcessor MyProcessor { [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
