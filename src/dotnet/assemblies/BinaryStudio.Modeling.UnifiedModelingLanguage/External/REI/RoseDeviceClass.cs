...
// Type: RationalRose.RoseDeviceClass
...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseDeviceClass : IREICOMDevice, REICOMDevice
  {
    ...
    [DispId(412)]
    public virtual extern String Characteristics { [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
    ...
    [DispId(12818)]
    public virtual extern REICOMConnectionRelationCollection Connections { [DispId(12818), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12818), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
    ...
    [DispId(415)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern Boolean AddProcessorConnection([MarshalAs(UnmanagedType.Interface)] REICOMProcessor theProcessor);
