...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseDeviceClass : IREICOMDevice, RoseDevice
  {
    ...
    [DispId(12818)]
    public virtual extern RoseConnectionRelationCollection Connections { [DispId(12818), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12818), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
