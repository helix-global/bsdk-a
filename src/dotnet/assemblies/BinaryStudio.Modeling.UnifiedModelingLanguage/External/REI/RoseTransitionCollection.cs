...
// Type: RationalRose.RoseTransitionCollection
...
namespace RationalRose
{
  ...
  [CoClass(typeof (RoseTransitionCollectionClass))]
  [ComImport]
  public interface RoseTransitionCollection : IREICOMTransitionCollection
  {
  }
}
