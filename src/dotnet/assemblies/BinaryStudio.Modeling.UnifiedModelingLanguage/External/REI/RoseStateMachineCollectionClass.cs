...
// Type: RationalRose.RoseStateMachineCollectionClass
...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseStateMachineCollectionClass : IREICOMStateMachineCollection, RoseStateMachineCollection
  {
