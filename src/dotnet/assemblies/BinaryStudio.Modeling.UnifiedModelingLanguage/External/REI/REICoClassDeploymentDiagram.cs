...
namespace RationalRose
    ...
    [ComImport]
    internal class REICoClassDeploymentDiagram : REICOMDeploymentDiagram
        {
        ...
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern IREICOMProcessorCollection GetProcessors();

        [DispId(412)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern IREICOMDeviceCollection GetDevices();

        [DispId(413)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern IREICOMItemView AddProcessor([MarshalAs(UnmanagedType.Interface)] IREICOMProcessor theProcessor, Int16 x, Int16 y);

        [DispId(414)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern IREICOMItemView AddDevice([MarshalAs(UnmanagedType.Interface)] IREICOMDevice theDevice, Int16 x, Int16 y);

        [DispId(415)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern Boolean RemoveProcessor([MarshalAs(UnmanagedType.Interface)] IREICOMProcessor theProcessor);

        [DispId(416)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern Boolean RemoveDevice([MarshalAs(UnmanagedType.Interface)] IREICOMDevice theDevice);
