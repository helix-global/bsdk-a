...
namespace RationalRose
    ...
    [ComImport]
    public class REICoClassDeploymentDiagram : IREICOMDeploymentDiagram, REICOMDeploymentDiagram
        {
        ...
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern REICOMProcessorCollection GetProcessors();
        ...
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern REICOMItemView AddProcessor([MarshalAs(UnmanagedType.Interface)] REICOMProcessor theProcessor, Int16 x, Int16 y);

        [DispId(414)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern REICOMItemView AddDevice([MarshalAs(UnmanagedType.Interface)] REICOMDevice theDevice, Int16 x, Int16 y);

        [DispId(415)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern Boolean RemoveProcessor([MarshalAs(UnmanagedType.Interface)] REICOMProcessor theProcessor);
