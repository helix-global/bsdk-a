...
namespace RationalRose
    ...
    public interface IREICOMInheritRelation
        ...
        [DispId(819)]
        IREICOMRichType ExportControl { [DispId(819), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(819), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
