...
// Type: RationalRose.RoseStateDiagramCollection
...
namespace RationalRose
{
  ...
  [CoClass(typeof (REICoClassStateDiagramCollection))]
  [ComImport]
  public interface RoseStateDiagramCollection : IREICOMStateDiagramCollection
  {
  }
}
