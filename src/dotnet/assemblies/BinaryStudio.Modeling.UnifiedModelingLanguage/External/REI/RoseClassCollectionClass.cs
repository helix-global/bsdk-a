...
// Type: RationalRose.RoseClassCollectionClass
...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseClassCollectionClass : IRoseClassCollection, RoseClassCollection
  {
    ...
    public virtual extern IRoseClass GetAt(Int16 Index);
