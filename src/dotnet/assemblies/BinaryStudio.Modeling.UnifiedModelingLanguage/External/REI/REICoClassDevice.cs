...
namespace RationalRose
    ...
    internal class REICoClassDevice : REICOMDevice
        ...
        [DispId(12818)]
        public virtual extern IREICOMConnectionRelationCollection Connections { [DispId(12818), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12818), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
        ...
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern IREICOMProcessorCollection GetConnectedProcessors();

        [DispId(414)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern IREICOMDeviceCollection GetConnectedDevices();

        [DispId(415)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern Boolean AddProcessorConnection([MarshalAs(UnmanagedType.Interface)] IREICOMProcessor theProcessor);

        [DispId(416)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern Boolean RemoveProcessorConnection([MarshalAs(UnmanagedType.Interface)] IREICOMProcessor theProcessor);

        [DispId(417)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern Boolean AddDeviceConnection([MarshalAs(UnmanagedType.Interface)] IREICOMDevice theDevice);

        [DispId(418)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern Boolean RemoveDeviceConnection([MarshalAs(UnmanagedType.Interface)] IREICOMDevice theDevice);
