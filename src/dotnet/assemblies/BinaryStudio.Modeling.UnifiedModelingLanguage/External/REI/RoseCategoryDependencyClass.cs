...
// Type: RationalRose.RoseCategoryDependencyClass
...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseCategoryDependencyClass : IREICOMCategoryDependency, REICOMCategoryDependency
  {
    ...
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.Interface)]
    public virtual extern REICOMCategory GetContextCategory();

    [DispId(12658)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.Interface)]
    public virtual extern REICOMCategory GetSupplierCategory();
