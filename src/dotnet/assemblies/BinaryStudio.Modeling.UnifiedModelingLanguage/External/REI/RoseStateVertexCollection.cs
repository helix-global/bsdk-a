...
// Type: RationalRose.RoseStateVertexCollection
...
namespace RationalRose
{
  ...
  [CoClass(typeof (REICoClassStateVertexCollection))]
  [ComImport]
  public interface RoseStateVertexCollection : IREICOMStateVertexCollection
  {
  }
}
