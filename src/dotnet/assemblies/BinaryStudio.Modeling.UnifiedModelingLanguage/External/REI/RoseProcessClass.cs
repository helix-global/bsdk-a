...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseProcessClass : IREICOMProcess, RoseProcess
  {
    ...
    [DispId(412)]
    public virtual extern RoseProcessor MyProcessor { [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
