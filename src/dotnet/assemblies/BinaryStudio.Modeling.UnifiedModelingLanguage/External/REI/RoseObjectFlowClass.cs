...
// Type: RationalRose.RoseObjectFlowClass
...
namespace RationalRose
{
  ...
  [ComImport]
  public class RoseObjectFlowClass : IREICOMObjectFlow, REICOMObjectFlow
  {
    ...
    [DispId(12842)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern Boolean SetState([MarshalAs(UnmanagedType.Interface)] RoseState theState);
