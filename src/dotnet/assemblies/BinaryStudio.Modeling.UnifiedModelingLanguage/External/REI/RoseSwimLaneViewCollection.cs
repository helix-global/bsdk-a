...
// Type: RationalRose.RoseSwimLaneViewCollection
...
namespace RationalRose
{
  ...
  [CoClass(typeof (REICoClassSwimLaneViewCollection))]
  [ComImport]
  public interface RoseSwimLaneViewCollection : IREICOMSwimLaneViewCollection
  {
  }
}
