...
// Type: RationalRose.RoseOperationCollection
...
namespace RationalRose
{
  ...
  [CoClass(typeof (RoseOperationCollectionClass))]
  [ComImport]
  public interface RoseOperationCollection : IREICOMOperationCollection
  {
  }
}
