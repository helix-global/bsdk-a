...
namespace RationalRose
    ...
    [ComImport]
    public interface IREICOMProcess
        {
        [DispId(100)]
        ...
        [DispId(412)]
        IREICOMProcessor MyProcessor { [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(412), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
