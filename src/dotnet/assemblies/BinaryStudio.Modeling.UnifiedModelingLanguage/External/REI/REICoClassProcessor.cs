...
namespace RationalRose
    ...
    [ComImport]
    public class REICoClassProcessor : IREICOMProcessor, REICOMProcessor
        {
        ...
        [DispId(414)]
        public virtual extern REICOMRichType Scheduling { [DispId(414), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(414), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
