...
// Type: RationalRose.RoseClassDiagramCollection
...
namespace RationalRose
{
  ...
  [CoClass(typeof (RoseClassDiagramCollectionClass))]
  [ComImport]
  public interface RoseClassDiagramCollection : IREICOMClassDiagramCollection
  {
  }
}
