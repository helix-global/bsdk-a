...
namespace RationalRose
    ...
    [ComImport]
    public class REICoClassOperation : IREICOMOperation, REICOMOperation
        {
        ...
        [DispId(414)]
        public virtual extern REICOMRichType ExportControl { [DispId(414), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(414), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

        [DispId(415)]
        public virtual extern REICOMRichType Concurrency { [DispId(415), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(415), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
