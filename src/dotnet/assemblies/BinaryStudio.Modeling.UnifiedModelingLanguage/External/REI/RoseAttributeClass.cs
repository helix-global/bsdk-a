...
namespace RationalRose
{
  ...
  public class RoseAttributeClass : IREICOMAttribute, RoseAttribute
  {
    ...
    [DispId(415)]
    public virtual extern IRoseRichType ExportControl { [DispId(415), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(415), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

    [DispId(416)]
    public virtual extern IRoseRichType Containment { [DispId(416), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(416), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
