...
namespace RationalRose
    ...
    [ComImport]
    public interface IREICOMActivity : IREICOMStateVertex
        {
        [DispId(444)]
        ...
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        IREICOMObjectFlow AddObjectFlow([MarshalAs(UnmanagedType.Interface)] IREICOMObjectInstance theObjectInstance);
