...
// Type: RationalRose.IRoseObjectInstance
...
namespace RationalRose
{
  ...
  [ComImport]
  public interface IRoseObjectInstance
  {
    [DispId(100)]
    ...
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.Interface)]
    RoseObjectFlow AddObjectFlow([MarshalAs(UnmanagedType.Interface)] RoseActivity theActivity);
