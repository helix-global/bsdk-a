...
namespace RationalRose
    ...
    [ComImport]
    public class REICoClassActivity : IRoseActivity, REICOMActivity
        {
        ...
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern REICOMObjectFlow AddObjectFlow([MarshalAs(UnmanagedType.Interface)] REICOMObjectInstance theObjectInstance);

        [DispId(12840)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern Boolean DeleteObjectFlow([MarshalAs(UnmanagedType.Interface)] REICOMObjectFlow theObjectFlow);

        [DispId(12853)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern REICOMObjectFlowCollection GetObjectFlows();
