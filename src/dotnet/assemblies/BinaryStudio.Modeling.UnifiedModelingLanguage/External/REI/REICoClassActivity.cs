...
namespace RationalRose
    ...
    [Guid("BEAED5E8-578D-11D2-92AA-004005141253")]
    [ComImport]
    internal class REICoClassActivity : REICOMActivity
        {
        //[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        //public extern RoseActivityClass();
        ...
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern IREICOMObjectFlow AddObjectFlow([MarshalAs(UnmanagedType.Interface)] IREICOMObjectInstance theObjectInstance);

        [DispId(12840)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern Boolean DeleteObjectFlow([MarshalAs(UnmanagedType.Interface)] IREICOMObjectFlow theObjectFlow);

        [DispId(12853)]
        [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [return: MarshalAs(UnmanagedType.Interface)]
        public virtual extern IREICOMObjectFlowCollection GetObjectFlows();
