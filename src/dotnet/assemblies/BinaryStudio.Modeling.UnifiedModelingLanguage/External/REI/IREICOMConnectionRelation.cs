...
namespace RationalRose
    ...
    [ComImport]
    public interface IREICOMConnectionRelation
        {
        [DispId(100)]
        ...
        [DispId(12815)]
        String Characteristics { [DispId(12815), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12815), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

        [DispId(12816)]
        Boolean SupplierIsDevice { [DispId(12816), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(12816), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
