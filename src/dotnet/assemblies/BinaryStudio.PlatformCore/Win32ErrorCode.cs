namespace BinaryStudio.PlatformComponents.Win32
    ...
    public enum Win32ErrorCode
        ...
        NERR_NetNotStarted                                            = 0x0836,
        NERR_UnknownServer                                            = 0x0837,
        NERR_ShareMem                                                 = 0x0838,
        NERR_NoNetworkResource                                        = 0x0839,
        NERR_RemoteOnly                                               = 0x083A,
        NERR_DevNotRedirected                                         = 0x083B,
        ERROR_CONNECTED_OTHER_PASSWORD                                = 0x083C,
        ERROR_CONNECTED_OTHER_PASSWORD_DEFAULT                        = 0x083D,
        NERR_ServerNotStarted                                         = 0x0842,
        NERR_ItemNotFound                                             = 0x0843,
        NERR_UnknownDevDir                                            = 0x0844,
        NERR_RedirectedPath                                           = 0x0845,
        NERR_DuplicateShare                                           = 0x0846,
        NERR_NoRoom                                                   = 0x0847,
        NERR_TooManyItems                                             = 0x0849,
        NERR_InvalidMaxUsers                                          = 0x084A,
        NERR_BufTooSmall                                              = 0x084B,
        NERR_RemoteErr                                                = 0x084F,
        NERR_LanmanIniError                                           = 0x0853,
        NERR_NetworkError                                             = 0x0858,
        NERR_WkstaInconsistentState                                   = 0x0859,
        NERR_WkstaNotStarted                                          = 0x085A,
        NERR_BrowserNotStarted                                        = 0x085B,
        NERR_InternalError                                            = 0x085C,
        NERR_BadTransactConfig                                        = 0x085D,
        NERR_InvalidAPI                                               = 0x085E,
        NERR_BadEventName                                             = 0x085F,
        NERR_DupNameReboot                                            = 0x0860,
        NERR_CfgCompNotFound                                          = 0x0862,
        NERR_CfgParamNotFound                                         = 0x0863,
        NERR_LineTooLong                                              = 0x0865,
        NERR_QNotFound                                                = 0x0866,
        NERR_JobNotFound                                              = 0x0867,
        NERR_DestNotFound                                             = 0x0868,
        NERR_DestExists                                               = 0x0869,
        NERR_QExists                                                  = 0x086A,
        NERR_QNoRoom                                                  = 0x086B,
        NERR_JobNoRoom                                                = 0x086C,
        NERR_DestNoRoom                                               = 0x086D,
        NERR_DestIdle                                                 = 0x086E,
        NERR_DestInvalidOp                                            = 0x086F,
        NERR_ProcNoRespond                                            = 0x0870,
        NERR_SpoolerNotLoaded                                         = 0x0871,
        NERR_DestInvalidState                                         = 0x0872,
        NERR_QinvalidState                                            = 0x0873,
        NERR_JobInvalidState                                          = 0x0874,
        NERR_SpoolNoMemory                                            = 0x0875,
        NERR_DriverNotFound                                           = 0x0876,
        NERR_DataTypeInvalid                                          = 0x0877,
        NERR_ProcNotFound                                             = 0x0878,
        NERR_ServiceTableLocked                                       = 0x0884,
        NERR_ServiceTableFull                                         = 0x0885,
        NERR_ServiceInstalled                                         = 0x0886,
        NERR_ServiceEntryLocked                                       = 0x0887,
        NERR_ServiceNotInstalled                                      = 0x0888,
        NERR_BadServiceName                                           = 0x0889,
        NERR_ServiceCtlTimeout                                        = 0x088A,
        NERR_ServiceCtlBusy                                           = 0x088B,
        NERR_BadServiceProgName                                       = 0x088C,
        NERR_ServiceNotCtrl                                           = 0x088D,
        NERR_ServiceKillProc                                          = 0x088E,
        NERR_ServiceCtlNotValid                                       = 0x088F,
        NERR_NotInDispatchTbl                                         = 0x0890,
        NERR_BadControlRecv                                           = 0x0891,
        NERR_ServiceNotStarting                                       = 0x0892,
        NERR_AlreadyLoggedOn                                          = 0x0898,
        NERR_NotLoggedOn                                              = 0x0899,
        NERR_BadUsername                                              = 0x089A,
        NERR_BadPassword                                              = 0x089B,
        NERR_UnableToAddName_W                                        = 0x089C,
        NERR_UnableToAddName_F                                        = 0x089D,
        NERR_UnableToDelName_W                                        = 0x089E,
        NERR_UnableToDelName_F                                        = 0x089F,
        NERR_LogonsPaused                                             = 0x08A1,
        NERR_LogonServerConflict                                      = 0x08A2,
        NERR_LogonNoUserPath                                          = 0x08A3,
        NERR_LogonScriptError                                         = 0x08A4,
        NERR_StandaloneLogon                                          = 0x08A6,
        NERR_LogonServerNotFound                                      = 0x08A7,
        NERR_LogonDomainExists                                        = 0x08A8,
        NERR_NonValidatedLogon                                        = 0x08A9,
        NERR_ACFNotFound                                              = 0x08AB,
        NERR_GroupNotFound                                            = 0x08AC,
        NERR_UserNotFound                                             = 0x08AD,
        NERR_ResourceNotFound                                         = 0x08AE,
        NERR_GroupExists                                              = 0x08AF,
        NERR_UserExists                                               = 0x08B0,
        NERR_ResourceExists                                           = 0x08B1,
        NERR_NotPrimary                                               = 0x08B2,
        NERR_ACFNotLoaded                                             = 0x08B3,
        NERR_ACFNoRoom                                                = 0x08B4,
        NERR_ACFFileIOFail                                            = 0x08B5,
        NERR_ACFTooManyLists                                          = 0x08B6,
        NERR_UserLogon                                                = 0x08B7,
        NERR_ACFNoParent                                              = 0x08B8,
        NERR_CanNotGrowSegment                                        = 0x08B9,
        NERR_SpeGroupOp                                               = 0x08BA,
        NERR_NotInCache                                               = 0x08BB,
        NERR_UserInGroup                                              = 0x08BC,
        NERR_UserNotInGroup                                           = 0x08BD,
        NERR_AccountUndefined                                         = 0x08BE,
        NERR_AccountExpired                                           = 0x08BF,
        NERR_InvalidWorkstation                                       = 0x08C0,
        NERR_InvalidLogonHours                                        = 0x08C1,
        NERR_PasswordExpired                                          = 0x08C2,
        NERR_PasswordCantChange                                       = 0x08C3,
        NERR_PasswordHistConflict                                     = 0x08C4,
        NERR_PasswordTooShort                                         = 0x08C5,
        NERR_PasswordTooRecent                                        = 0x08C6,
        NERR_InvalidDatabase                                          = 0x08C7,
        NERR_DatabaseUpToDate                                         = 0x08C8,
        NERR_SyncRequired                                             = 0x08C9,
        NERR_UseNotFound                                              = 0x08CA,
        NERR_BadAsgType                                               = 0x08CB,
        NERR_DeviceIsShared                                           = 0x08CC,
        NERR_NoComputerName                                           = 0x08DE,
        NERR_MsgAlreadyStarted                                        = 0x08DF,
        NERR_MsgInitFailed                                            = 0x08E0,
        NERR_NameNotFound                                             = 0x08E1,
        NERR_AlreadyForwarded                                         = 0x08E2,
        NERR_AddForwarded                                             = 0x08E3,
        NERR_AlreadyExists                                            = 0x08E4,
        NERR_TooManyNames                                             = 0x08E5,
        NERR_DelComputerName                                          = 0x08E6,
        NERR_LocalForward                                             = 0x08E7,
        NERR_GrpMsgProcessor                                          = 0x08E8,
        NERR_PausedRemote                                             = 0x08E9,
        NERR_BadReceive                                               = 0x08EA,
        NERR_NameInUse                                                = 0x08EB,
        NERR_MsgNotStarted                                            = 0x08EC,
        NERR_NotLocalName                                             = 0x08ED,
        NERR_NoForwardName                                            = 0x08EE,
        NERR_RemoteFull                                               = 0x08EF,
        NERR_NameNotForwarded                                         = 0x08F0,
        NERR_TruncatedBroadcast                                       = 0x08F1,
        NERR_InvalidDevice                                            = 0x08F6,
        NERR_WriteFault                                               = 0x08F7,
        NERR_DuplicateName                                            = 0x08F9,
        NERR_DeleteLater                                              = 0x08FA,
        NERR_IncompleteDel                                            = 0x08FB,
        NERR_MultipleNets                                             = 0x08FC,
        NERR_NetNameNotFound                                          = 0x0906,
        NERR_DeviceNotShared                                          = 0x0907,
        NERR_ClientNameNotFound                                       = 0x0908,
        NERR_FileIdNotFound                                           = 0x090A,
        NERR_ExecFailure                                              = 0x090B,
        NERR_TmpFile                                                  = 0x090C,
        NERR_TooMuchData                                              = 0x090D,
        NERR_DeviceShareConflict                                      = 0x090E,
        NERR_BrowserTableIncomplete                                   = 0x090F,
        NERR_NotLocalDomain                                           = 0x0910,
        NERR_IsDfsShare                                               = 0x0911,
        NERR_DevInvalidOpCode                                         = 0x091B,
        NERR_DevNotFound                                              = 0x091C,
        NERR_DevNotOpen                                               = 0x091D,
        NERR_BadQueueDevString                                        = 0x091E,
        NERR_BadQueuePriority                                         = 0x091F,
        NERR_NoCommDevs                                               = 0x0921,
        NERR_QueueNotFound                                            = 0x0922,
        NERR_BadDevString                                             = 0x0924,
        NERR_BadDev                                                   = 0x0925,
        NERR_InUseBySpooler                                           = 0x0926,
        NERR_CommDevInUse                                             = 0x0927,
        NERR_InvalidComputer                                          = 0x092F,
        NERR_MaxLenExceeded                                           = 0x0932,
        NERR_BadComponent                                             = 0x0934,
        NERR_CantType                                                 = 0x0935,
        NERR_TooManyEntries                                           = 0x093A,
        NERR_ProfileFileTooBig                                        = 0x0942,
        NERR_ProfileOffset                                            = 0x0943,
        NERR_ProfileCleanup                                           = 0x0944,
        NERR_ProfileUnknownCmd                                        = 0x0945,
        NERR_ProfileLoadErr                                           = 0x0946,
        NERR_ProfileSaveErr                                           = 0x0947,
        NERR_LogOverflow                                              = 0x0949,
        NERR_LogFileChanged                                           = 0x094A,
        NERR_LogFileCorrupt                                           = 0x094B,
        NERR_SourceIsDir                                              = 0x094C,
        NERR_BadSource                                                = 0x094D,
        NERR_BadDest                                                  = 0x094E,
        NERR_DifferentServers                                         = 0x094F,
        NERR_RunSrvPaused                                             = 0x0951,
        NERR_ErrCommRunSrv                                            = 0x0955,
        NERR_ErrorExecingGhost                                        = 0x0957,
        NERR_ShareNotFound                                            = 0x0958,
        NERR_InvalidLana                                              = 0x0960,
        NERR_OpenFiles                                                = 0x0961,
        NERR_ActiveConns                                              = 0x0962,
        NERR_BadPasswordCore                                          = 0x0963,
        NERR_DevInUse                                                 = 0x0964,
        NERR_LocalDrive                                               = 0x0965,
        NERR_AlertExists                                              = 0x097E,
        NERR_TooManyAlerts                                            = 0x097F,
        NERR_NoSuchAlert                                              = 0x0980,
        NERR_BadRecipient                                             = 0x0981,
        NERR_AcctLimitExceeded                                        = 0x0982,
        NERR_InvalidLogSeek                                           = 0x0988,
        NERR_BadUasConfig                                             = 0x0992,
        NERR_InvalidUASOp                                             = 0x0993,
        NERR_LastAdmin                                                = 0x0994,
        NERR_DCNotFound                                               = 0x0995,
        NERR_LogonTrackingError                                       = 0x0996,
        NERR_NetlogonNotStarted                                       = 0x0997,
        NERR_CanNotGrowUASFile                                        = 0x0998,
        NERR_TimeDiffAtDC                                             = 0x0999,
        NERR_PasswordMismatch                                         = 0x099A,
        NERR_NoSuchServer                                             = 0x099C,
        NERR_NoSuchSession                                            = 0x099D,
        NERR_NoSuchConnection                                         = 0x099E,
        NERR_TooManyServers                                           = 0x099F,
        NERR_TooManySessions                                          = 0x09A0,
        NERR_TooManyConnections                                       = 0x09A1,
        NERR_TooManyFiles                                             = 0x09A2,
        NERR_NoAlternateServers                                       = 0x09A3,
        NERR_TryDownLevel                                             = 0x09A6,
        NERR_UPSDriverNotStarted                                      = 0x09B0,
        NERR_UPSInvalidConfig                                         = 0x09B1,
        NERR_UPSInvalidCommPort                                       = 0x09B2,
        NERR_UPSSignalAsserted                                        = 0x09B3,
        NERR_UPSShutdownFailed                                        = 0x09B4,
        NERR_BadDosRetCode                                            = 0x09C4,
        NERR_ProgNeedsExtraMem                                        = 0x09C5,
        NERR_BadDosFunction                                           = 0x09C6,
        NERR_RemoteBootFailed                                         = 0x09C7,
        NERR_BadFileCheckSum                                          = 0x09C8,
        NERR_NoRplBootSystem                                          = 0x09C9,
        NERR_RplLoadrNetBiosErr                                       = 0x09CA,
        NERR_RplLoadrDiskErr                                          = 0x09CB,
        NERR_ImageParamErr                                            = 0x09CC,
        NERR_TooManyImageParams                                       = 0x09CD,
        NERR_NonDosFloppyUsed                                         = 0x09CE,
        NERR_RplBootRestart                                           = 0x09CF,
        NERR_RplSrvrCallFailed                                        = 0x09D0,
        NERR_CantConnectRplSrvr                                       = 0x09D1,
        NERR_CantOpenImageFile                                        = 0x09D2,
        NERR_CallingRplSrvr                                           = 0x09D3,
        NERR_StartingRplBoot                                          = 0x09D4,
        NERR_RplBootServiceTerm                                       = 0x09D5,
        NERR_RplBootStartFailed                                       = 0x09D6,
        NERR_RPL_CONNECTED                                            = 0x09D7,
        NERR_BrowserConfiguredToNotRun                                = 0x09F6,
        NERR_RplNoAdaptersStarted                                     = 0x0A32,
        NERR_RplBadRegistry                                           = 0x0A33,
        NERR_RplBadDatabase                                           = 0x0A34,
        NERR_RplRplfilesShare                                         = 0x0A35,
        NERR_RplNotRplServer                                          = 0x0A36,
        NERR_RplCannotEnum                                            = 0x0A37,
        NERR_RplWkstaInfoCorrupted                                    = 0x0A38,
        NERR_RplWkstaNotFound                                         = 0x0A39,
        NERR_RplWkstaNameUnavailable                                  = 0x0A3A,
        NERR_RplProfileInfoCorrupted                                  = 0x0A3B,
        NERR_RplProfileNotFound                                       = 0x0A3C,
        NERR_RplProfileNameUnavailable                                = 0x0A3D,
        NERR_RplProfileNotEmpty                                       = 0x0A3E,
        NERR_RplConfigInfoCorrupted                                   = 0x0A3F,
        NERR_RplConfigNotFound                                        = 0x0A40,
        NERR_RplAdapterInfoCorrupted                                  = 0x0A41,
        NERR_RplInternal                                              = 0x0A42,
        NERR_RplVendorInfoCorrupted                                   = 0x0A43,
        NERR_RplBootInfoCorrupted                                     = 0x0A44,
        NERR_RplWkstaNeedsUserAcct                                    = 0x0A45,
        NERR_RplNeedsRPLUSERAcct                                      = 0x0A46,
        NERR_RplBootNotFound                                          = 0x0A47,
        NERR_RplIncompatibleProfile                                   = 0x0A48,
        NERR_RplAdapterNameUnavailable                                = 0x0A49,
        NERR_RplConfigNotEmpty                                        = 0x0A4A,
        NERR_RplBootInUse                                             = 0x0A4B,
        NERR_RplBackupDatabase                                        = 0x0A4C,
        NERR_RplAdapterNotFound                                       = 0x0A4D,
        NERR_RplVendorNotFound                                        = 0x0A4E,
        NERR_RplVendorNameUnavailable                                 = 0x0A4F,
        NERR_RplBootNameUnavailable                                   = 0x0A50,
        NERR_RplConfigNameUnavailable                                 = 0x0A51,
        NERR_DfsInternalCorruption                                    = 0x0A64,
        NERR_DfsVolumeDataCorrupt                                     = 0x0A65,
        NERR_DfsNoSuchVolume                                          = 0x0A66,
        NERR_DfsVolumeAlreadyExists                                   = 0x0A67,
        NERR_DfsAlreadyShared                                         = 0x0A68,
        NERR_DfsNoSuchShare                                           = 0x0A69,
        NERR_DfsNotALeafVolume                                        = 0x0A6A,
        NERR_DfsLeafVolume                                            = 0x0A6B,
        NERR_DfsVolumeHasMultipleServers                              = 0x0A6C,
        NERR_DfsCantCreateJunctionPoint                               = 0x0A6D,
        NERR_DfsServerNotDfsAware                                     = 0x0A6E,
        NERR_DfsBadRenamePath                                         = 0x0A6F,
        NERR_DfsVolumeIsOffline                                       = 0x0A70,
        NERR_DfsNoSuchServer                                          = 0x0A71,
        NERR_DfsCyclicalName                                          = 0x0A72,
        NERR_DfsNotSupportedInServerDfs                               = 0x0A73,
        NERR_DfsDuplicateService                                      = 0x0A74,
        NERR_DfsCantRemoveLastServerShare                             = 0x0A75,
        NERR_DfsVolumeIsInterDfs                                      = 0x0A76,
        NERR_DfsInconsistent                                          = 0x0A77,
        NERR_DfsServerUpgraded                                        = 0x0A78,
        NERR_DfsDataIsIdentical                                       = 0x0A79,
        NERR_DfsCantRemoveDfsRoot                                     = 0x0A7A,
        NERR_DfsChildOrParentInDfs                                    = 0x0A7B,
        NERR_DfsInternalError                                         = 0x0A82,
        NERR_SetupAlreadyJoined                                       = 0x0A83,
        NERR_SetupNotJoined                                           = 0x0A84,
        NERR_SetupDomainController                                    = 0x0A85,
        NERR_DefaultJoinRequired                                      = 0x0A86,
        NERR_InvalidWorkgroupName                                     = 0x0A87,
        NERR_NameUsesIncompatibleCodePage                             = 0x0A88,
        NERR_ComputerAccountNotFound                                  = 0x0A89,
        NERR_PersonalSku                                              = 0x0A8A,
        NERR_PasswordMustChange                                       = 0x0A8D,
        NERR_AccountLockedOut                                         = 0x0A8E,
        NERR_PasswordTooLong                                          = 0x0A8F,
        NERR_PasswordNotComplexEnough                                 = 0x0A90,
        NERR_PasswordFilterError                                      = 0x0A91,
        ...
        ERROR_IPSEC_TRANSPORT_FILTER_ENDING_DELETION                  = 0x32DB,
        ERROR_IPSEC_TUNNEL_FILTER_PENDING_DELETION                    = 0x32DC,
        ERROR_IPSEC_MM_POLICY_PENDING_ELETION                         = 0x32DD,
        ...
        ERROR_IPSEC_IKE_INVALID_UMATTS                                = 0x3641,
        ...
        ERROR_SXS_ROOT_MANIFEST_DEPENDENCY_OT_INSTALLED               = 0x36BF,
        ...
        ERROR_SXS_PROTECTION_PUBLIC_KEY_OO_SHORT                      = 0x36FB,
        ...
        ERROR_SXS_RELEASE_ACTIVATION_ONTEXT                           = 0x3708,
        ...
        ERROR_SXS_INCORRECT_PUBLIC_KEY_OKEN                           = 0x370F,
        ...
        ERROR_EVT_EVENT_DEFINITION_NOT_OUND                           = 0x3AB8,
