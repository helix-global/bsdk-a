...
namespace BinaryStudio.PlatformUI.Controls.Primitives
{
    public class PolyBezier : Shape
        ...
        public static readonly DependencyProperty PointsProperty = DependencyProperty.Register("Points", typeof(PointCollection), typeof(PolyBezier), new PropertyMetadata(default(PointCollection), OnPointsChanged));
        private static void OnPointsChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
            {
            var source = (sender as PolyBezier);
            if (source != null)
                {
        ...
        public static readonly DependencyProperty FillRuleProperty = DependencyProperty.Register("FillRule", typeof(FillRule), typeof(PolyBezier), new PropertyMetadata(default(FillRule), OnFillRuleChanged));
        ...
        private void UpdateGeometry() {
            ...
            if (points.Count > 0)
                ...
                if (points.Count > 1)
                    ...
                    pathfigure.Segments.Add(new PolyBezierSegment(array, true));
                    }
                }
